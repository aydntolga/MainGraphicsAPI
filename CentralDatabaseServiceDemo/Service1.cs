using CentralDatabaseServiceDemo.Infos;
...
namespace CentralDatabaseServiceDemo
{
    public partial class Service1 : ServiceBase
    {
        ...
        private void SyncTableData(string databaseName, TableInfo tableInfo, SqlConnection sourceConnection, SqlConnection destinationConnection)
        {
            ...
            try
            {
                ...
                if (currentTableSize != null)
                {
                    ...
                    string customerName = databaseName; // Müşteri adı
        ...
        private DatabaseInfo GetDatabaseInfoFor(string databaseName)
        {
            ...
            // Oluşturulan tablo bilgilerini DatabaseInfo nesnesine ekle
            return new DatabaseInfo
            {
                Name = databaseName,
                ConnectionString = connectionString,
                Tables = tables,
                CustomerName = databaseName // Müşteri adını veritabanı adıyla aynı yap
            };
        }
